...
This is the MCP (Model Context Protocol) server for the Prophet project. It provides tools for the Prophet agent to interact with the Monad testnet and retrieve on-chain data.
...
1. `get-mon-balance`: Get the MON balance of an address on Monad testnet
